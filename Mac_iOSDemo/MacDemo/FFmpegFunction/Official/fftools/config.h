...
#define FFMPEG_CONFIGURATION "--target-os=darwin --arch=x86_64 --cc='xcrun -sdk macosx clang' --as='gas-preprocessor.pl -- xcrun -sdk macosx clang' --disable-gpl --disable-nonfree --enable-cross-compile --disable-debug --enable-pic --enable-runtime-cpudetect --disable-gray --disable-swscale-alpha --disable-programs --enable-ffmpeg --enable-ffplay --enable-ffprobe --enable-ffserver --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-indevs --enable-outdevs --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --disable-postproc --enable-avfilter --disable-avresample --enable-network --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vdpau --disable-encoders --enable-encoder=png --enable-encoder=mjpeg --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=h264 --enable-encoder=hevc --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=flv --enable-decoder=h264 --enable-decoder='mp3*' --enable-decoder=vp6f --enable-decoder=flac --enable-decoder=hevc --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=pcm_s16le --disable-hwaccels --disable-muxers --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=mov --enable-muxer=mjpeg --enable-muxer=avi --enable-muxer=h264 --disable-demuxers --enable-demuxer=rtsp --enable-demuxer=mjpeg --enable-demuxer=avi --enable-demuxer=h264 --enable-demuxer=pcm_s16le --enable-demuxer=aac --enable-demuxer=concat --enable-demuxer=data --enable-demuxer=flv --enable-demuxer=hls --enable-demuxer=live_flv --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=flac --enable-demuxer=hevc --enable-demuxer=webm_dash_manifest --disable-parsers --enable-parser=mjpeg --enable-parser=mpeg4video --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=flac --enable-parser=hevc --enable-bsfs --enable-bsf=chomp --enable-bsf=dca_core --enable-bsf=dump_extradata --enable-bsf=hevc_mp4toannexb --enable-bsf=imx_dump_header --enable-bsf=mjpeg2jpeg --enable-bsf=mjpega_dump_header --enable-bsf=mov2textsub --enable-bsf=mp3_header_decompress --enable-bsf=mpeg4_unpack_bframes --enable-bsf=noise --enable-bsf=remove_extradata --enable-bsf=text2movsub --enable-bsf=vp9_superframe --disable-protocols --enable-protocol=async --enable-protocol=file --enable-protocol=udp --enable-protocol=tcp --enable-protocol=rtp --disable-devices --disable-filters --enable-filter=nullsrc --enable-filter=nullsink --enable-filter=hflip --enable-filter=vflip --enable-filter=rotate --enable-filter=transpose --enable-filter=anullsrc --enable-filter=anullsink --enable-filter=aresample --disable-audiotoolbox --disable-videotoolbox --disable-iconv --disable-bzlib --disable-vda --disable-asm --extra-cflags='-arch x86_64 -mmacosx-version-min=10.14' --extra-ldflags='-arch x86_64 -mmacosx-version-min=10.14' --prefix=/Users/anderson/Desktop/ffmpeg/build/ffmpeg_macos/thin/x86_64"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/Users/anderson/Desktop/ffmpeg/build/ffmpeg_macos/thin/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "/Users/anderson/Desktop/ffmpeg/build/ffmpeg_macos/thin/x86_64/share/ffmpeg"
...
#define CONFIG_IJKLONGURL_PROTOCOL 0
#define CONFIG_IJKMEDIADATASOURCE_PROTOCOL 0
#define CONFIG_IJKSEGMENT_PROTOCOL 0
#define CONFIG_IJKTCPHOOK_PROTOCOL 0
#define CONFIG_IJKIO_PROTOCOL 0
