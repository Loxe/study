...
- (BOOL)initDecoder {
     ...
     * kCVPixelBufferPixelFormatTypeKey:摄像头的输出数据格式
     ...
     kCVPixelFormatType_420YpCbCr8BiPlanarVideoRange，即420v, 为NV12格式,  NV12为YUV420SP UV排列, NV21为YUV420SP VU排列
    ...
    /*
     ...
     参数5: 实际图像的缓冲/Users/sem/Desktop/AVDemo/AVDemo/AudioEncoder/SQAudioEncoder.m
     参数6: 出现的时间戳
     参数7: 出现的持续时间
     */
